...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'softDelete'); ?>
		<?php echo $form->checkBox($model,'softDelete'); ?>
		<div class="tooltip">
			Whether comments specified for the table columns should be used as the new model's attribute labels.
			In case your RDBMS doesn't support feature of commenting columns or column comment wasn't set,
			column name would be used as the attribute name base.
		</div>
		<?php echo $form->error($model,'softDelete'); ?>
	</div>

	<div class="row sticky">
		<?php echo $form->labelEx($model,'softDeleteField'); ?>
		<?php echo $form->textField($model,'softDeleteField',array('size'=>65)); ?>
		<div class="tooltip">
			This is the class that the new model class will extend from.
			Please make sure the class exists and can be autoloaded.
		</div>
		<?php echo $form->error($model,'softDeleteField'); ?>
	</div>
<?php $this->endWidget(); ?>
